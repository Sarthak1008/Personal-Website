...
@Component({
  ...
  imports: [RouterOutlet, FooterComponent, MatToolbarModule, MatButtonModule, MatIconModule,
    ...
    ExperienceComponent, ProjectsComponent, LifeBeyondCodeComponent, NgImageSliderModule, InterestComponent, HighlightsComponent, CodingJourneyComponent, GithubRepoAnalyserComponent, ChatbotComponent, LeetcodeComponent],
